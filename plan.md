...
- PostgreSQL: иерархический рубрикатор (темы, регионы, ведомства с parent-child), миграции
- Гибридный поиск: векторный + payload filtering (Qdrant) + SQL по иерархии (PostgreSQL)
