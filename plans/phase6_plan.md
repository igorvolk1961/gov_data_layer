...
- `core/ingest/embedder.py` — `Embedder` (sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 через sentence-transformers)
...
Чанкинг (DocStructSplitter)
    ↓
Эмбеддинг (sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 под sentence-transformers)
    ↓
...
**Обоснование sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2:** Высокая скорость на русском языке.
...
- [ ] `Embedder` (sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2) реализован
...
- `plans/adr.md` — добавить ADR:
  ...
  - Выбор sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2
...
- [ ] ADR дополнены (OCR, DocStructSplitter, sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2, RSSAdapter)
- [ ] SKILL.md обновлён
...
│   └── embedder.py                 # NEW: Embedder (sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2)
└── errors/
